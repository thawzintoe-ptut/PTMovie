...
import com.ptut.ptmovie.databinding.ListItemMovieBinding
...
class MovieAdapter @Inject constructor(
...
) : BaseRecyclerViewAdapter<MovieVO, MovieViewHolder>(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MovieViewHolder {
        val itemView = parent.inflater().inflate(R.layout.list_item_movie, parent, false)
...
) : BaseViewHolder<ListItemMovieBinding, MovieVO>(itemView) {
    override val binding: ListItemMovieBinding by lazy {
        ListItemMovieBinding.bind(itemView)
    }
